...
export interface CognitoCertStackProps extends StackProps {
  hostedZoneSharedAccount: r53.IHostedZone;
}

// This stack is on the shared account
export class CognitoCertStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: CognitoCertStackProps) {
    ...
    this.certificate = new DnsValidatedCertificate(
      ...
      "CrossAccountCertificate",
      {
        ...
        certificateRegion: "us-east-1", // cognito uses cloudfront, and cloudfront requires the cert to be in us-east-1
      }
    );
  }
}
