...
export const translateSitesGetSites = <
  TComposable extends Composable,
  DefaultT extends TranslateSitesGetSitesResponse = TranslateSitesGetSitesResponse,
>(
  options: Options<
    TComposable,
    TranslateSitesGetSitesData,
...
export const translateSitesPostSites = <
  TComposable extends Composable,
  DefaultT extends TranslateSitesPostSitesResponse = TranslateSitesPostSitesResponse,
>(
  options: Options<
    TComposable,
    TranslateSitesPostSitesData,
...
export const translateSitesDeleteSite = <
  TComposable extends Composable,
  DefaultT extends TranslateSitesDeleteSiteResponse = TranslateSitesDeleteSiteResponse,
>(
  options: Options<
    TComposable,
    TranslateSitesDeleteSiteData,
...
export const translateSitesGetSite = <
  TComposable extends Composable,
  DefaultT extends TranslateSitesGetSiteResponse = TranslateSitesGetSiteResponse,
>(
  options: Options<TComposable, TranslateSitesGetSiteData, TranslateSitesGetSiteResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).get<
    TComposable,
...
export const translateSitesPutSite = <
  TComposable extends Composable,
  DefaultT extends TranslateSitesPutSiteResponse = TranslateSitesPutSiteResponse,
>(
  options: Options<TComposable, TranslateSitesPutSiteData, TranslateSitesPutSiteResponse, DefaultT>,
) => {
...
export const translateSitesPostToggleSite = <
  TComposable extends Composable,
  DefaultT extends TranslateSitesPostToggleSiteResponse = TranslateSitesPostToggleSiteResponse,
>(
  options: Options<
    TComposable,
    TranslateSitesPostToggleSiteData,
...
export const dummyTranslateDummyPost = <
  TComposable extends Composable,
  DefaultT extends DummyTranslateDummyPostResponse = DummyTranslateDummyPostResponse,
>(
  options: Options<
    TComposable,
    DummyTranslateDummyPostData,
...
>(
  options: Options<TComposable, ConfigGetButtonData, ConfigGetButtonResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).get<
    TComposable,
...
>(
  options: Options<TComposable, ConfigPutButtonData, ConfigPutButtonResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).put<
    TComposable,
...
>(
  options: Options<TComposable, ConfigGetDataSourcesData, ConfigGetDataSourcesResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).get<
    TComposable,
...
>(
  options: Options<TComposable, ConfigPutDataSourcesData, ConfigPutDataSourcesResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).put<
    TComposable,
...
>(
  options: Options<TComposable, DeleteProfileData, DeleteProfileResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).delete<
    TComposable,
...
>(
  options: Options<TComposable, GetWebsiteOverridesData, GetWebsiteOverridesResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).get<
    TComposable,
...
>(
  options: Options<TComposable, PostWebsiteOverrideData, PostWebsiteOverrideResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).post<
    TComposable,
...
export const deleteWebsiteOverride = <
  TComposable extends Composable,
  DefaultT extends DeleteWebsiteOverrideResponse = DeleteWebsiteOverrideResponse,
>(
  options: Options<TComposable, DeleteWebsiteOverrideData, DeleteWebsiteOverrideResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).delete<
    TComposable,
...
>(
  options: Options<TComposable, GetWebsiteOverrideData, GetWebsiteOverrideResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).get<
    TComposable,
...
>(
  options: Options<TComposable, PutWebsiteOverrideData, PutWebsiteOverrideResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).put<
    TComposable,
...
>(
  options: Options<TComposable, ChatPostChatPublicData, ChatPostChatPublicResponse, DefaultT>,
) => {
  return (options.client ?? _heyApiClient).post<
    TComposable,
