      ...
      <ul class="space-y-2">
        <!-- <li>
          ...
          >
            ...
            <span class="ml-3">Widget Configuration</span>
          </a>
        </li> -->
        <li>
          <button
          ...
          >
            ...
            <span class="flex-1 ml-3 text-left whitespace-nowrap">Widget</span>
            <svg
              aria-hidden="true"
              class="w-6 h-6"
              fill="currentColor"
          ...
          <ul id="dropdown-pages" class="hidden py-2 space-y-2">
            <li>
              <NuxtLink
                :to="`/site/${$route.params.domain}/button`"
            ...
            <li>
              <NuxtLink
                :to="`/site/${$route.params.domain}/data-sources`"
                class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
